...
Function getTitlesMap()
    ...
    titles.Add positions("derniere_maj"), "Date de derni鑽e maj"
    ' Mat駻iel
    titles.Add positions("type_materiel"), "Type mat駻iel"
    titles.Add positions("marque"), "Marque"
    titles.Add positions("modele"), "Mod鑞e"
    titles.Add positions("os"), "Syst鑪e d'exploitation"
    titles.Add positions("no_serie"), "Num駻o de s駻ie"	
    ' DON
    titles.Add positions("date_crea_fiche_teck"), "Date de cr饌tion fiche technique"
    titles.Add positions("cree_par"), "Cr鳬e par"
    titles.Add positions("donateur"), "Donateur"
    titles.Add positions("coord_donateur"), "Coordonn馥s Contact Donateur"
    titles.Add positions("date_recpt_don"), "Date de r馗eption du don"
    titles.Add positions("comment_don"), "Commentaire sur le don"
    ' Cat馮orisation et calcul du prix de vente
    titles.Add positions("cpu"), "Processeur complet"
    titles.Add positions("cpu_indice"), "Indice CPU"
    titles.Add positions("mem"), "M駑oire (en Go)"
    ...
    titles.Add positions("pond_teck"), "Pond駻ation +/- technique"
    titles.Add positions("pond_aspect"), "Pond駻ation +/- Aspect"
    titles.Add positions("total"), "Total"
    titles.Add positions("cat_vente_calculee"), "Cat馮orie de vente calcul馥"
    titles.Add positions("prix_vente_calculee"), "Prix de vente calcul・
    titles.Add positions("comm_prix"), "Commentaire Prix"
    ' suivit reconditionnement
    titles.Add positions("benevole_charge_recond"), "B駭騅ole en charge du reconditionnement"
    ...
    titles.Add positions("utilisation_cle_win_10"), "Utilisation d'une cl・de licence Windows 10"
    titles.Add positions("ctrl_connect"), "Contre Connectique"
    titles.Add positions("eff_donnees"), "Effacement des donn馥s"
    ' vente
    titles.Add positions("dispo_vente_se"), "Disponible ・la vente SE (O/N)"
    titles.Add positions("date_vente"), "Date de la vente"
    titles.Add positions("comm_vente"), "Commentaire vente"
    ' fiche technique
    titles.Add positions("taille_ecran"), "Taille 馗ran"
    titles.Add positions("alim_chargeur"), "Alim. chargeur"
    titles.Add positions("cap_res_bat"), "Capacit・r駸iduelle Batterie (%)"
